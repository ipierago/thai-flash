...
async function main() {
  //await addNewTerms('gitignore/new-terms.txt', ['kruu bank', '26 oct 2022']);
  /*
  ...
  */
  //await mergeQuizlet();
  //await ensureAllMP3();
  await anki.exportListenDeck('26 oct 2022', 'gitignore/anki.listen.txt');
  await anki.exportSpeakDeck('26 oct 2022', 'gitignore/anki.speak.txt');
